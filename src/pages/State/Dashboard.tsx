  ...
  const handleStatsCardClick = (type: string) => {
    switch (type) {
      case 'districts':
        ...
        break;
      case 'assemblies':
        navigate('/state/assembly');
        break;
      case 'blocks':
        navigate('/state/block');
        break;
      case 'mandals':
        navigate('/state/mandal');
        break;
      case 'booths':
        navigate('/state/booth');
        break;
      default:
        break;
    }
  ...
  return (
    <div className="w-full py-1 min-h-screen box-border rounded-2xl shadow-md bg-gray-50 transition-all mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
        <div
          onClick={() => handleStatsCardClick('districts')}
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold mt-1">{counts.districts || 0}</p>
            </div>
        ...
        <div
          ...
          className="bg-linear-to-br from-violet-500 to-violet-600 rounded-xl shadow-lg p-5 text-white cursor-pointer hover:shadow-xl transition-all duration-200 hover:-translate-y-1"
        >
          <div className="flex items-center justify-between">
            <div>
