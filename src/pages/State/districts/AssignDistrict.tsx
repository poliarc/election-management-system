      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-[var(--bg-card)] rounded-lg shadow-md p-3">
          <div className="mb-1">
            ...
            <p className="text-sm text-[var(--text-secondary)] mt-1 px-13">
            ...
            <>
              {loadingAssignedUsers ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="mt-2 text-[var(--text-secondary)] font-medium">No users assigned to this district</p>
                  <p className="text-sm text-[var(--text-secondary)]">Use the "Assign Users" tab to assign users to this district.</p>
                </div>
              ) : (
                <>
                        ...
                        <div key={user.user_id} className="p-4 hover:bg-[var(--text-color)]/5">
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-[var(--text-secondary)]">{user.districtName}</p>
