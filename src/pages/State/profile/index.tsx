...
export const StateProfile = () => {
  ...
  return (
    <div className="w-full m-0 animate-fadeIn">
      {/* Header */}
      <div className="w-full bg-[var(--bg-card)] text-[var(--text-secondary)] shadow-lg hover:shadow-2xl transition-all duration-500 rounded-3xl flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 sm:p-8 border border-[var(--border-color)] backdrop-blur-sm transform hover:scale-[1.01]">
        <div
