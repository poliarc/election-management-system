        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 p-6">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg p-6 mb-6 text-white">
                    ...
                    <p className="text-blue-100 ml-14">Add a new assembly constituency to your district</p>
                </div>

                {/* Context Info Card */}
                <div className="bg-white rounded-xl shadow-md p-6 mb-6 border border-blue-100">
                    <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Current Context</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{districtInfo.stateName || "N/A"}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold text-gray-900">{districtInfo.districtName || "N/A"}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="assemblyName" className="block text-sm font-semibold text-gray-700 mb-2">
                                Assembly Constituency Name <span className="text-red-500">*</span>
                            </label>
                            ...
                            <p className="mt-2 text-xs text-gray-500">Enter the official name of the assembly constituency</p>
                        </div>
