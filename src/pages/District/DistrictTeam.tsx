...
export default function DistrictTeam() {
    ...
    const [districtData, setDistrictData] = useState<DistrictTeamResponse['data'] | null>(null);
    ...
    const filteredUsers = districtData?.users.filter(user => {
        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Loading district team...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            {/* Header */}
            <div className="bg-gradient-to-r from-sky-400 to-sky-500 rounded-lg shadow-lg p-6 text-white mb-6">
                <h1 className="text-3xl font-bold">{districtData.location.location_name} District Team</h1>
                <p className="text-sky-100 mt-2">Manage and view district team members</p>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900 mt-2">{districtData.total_users}</p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-green-600 mt-2">{districtData.active_users}</p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-red-600 mt-2">{districtData.inactive_users}</p>
                        </div>
                            ...
                            {filteredUsers.length === 0 ? (
                                ...
                                filteredUsers.map((user, index) => (
                                    <tr key={user.assignment_id || index} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-600">{user.party_name || 'N/A'}</td>
