...
export default function DistrictMandalList() {
    ...
    const [selectedAssemblyName, setSelectedAssemblyName] = useState<string>("");
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    const assembly = assemblies.find(a => (a.location_id || a.id) === assemblyId);
                                    setSelectedAssemblyName(assembly?.displayName || "");
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    {!selectedBlockId ? (
                        <div className="text-center py-12">
                            ...
                            <p className="mt-2 text-gray-500 font-medium">Please select Assembly and Block to view mandals</p>
                        </div>
                    ) : loadingMandals ? (
                        <div className="text-center py-12">
