...
export default function SubLevelChildHierarchy() {
    ...
    const getStateId = () => {
        // For SubLevel, we need to get state_id from the parent assembly
        // Try to get it from selectedAssignment or fetch from API
        ...
        // For now, try to get it from the level info or use a fallback
        try {
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-center">
                                                <div className="flex items-center justify-center gap-2">
                                                    <button
                                                        ...
                                                        className="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-teal-600 text-white hover:bg-teal-700"
                                                    >
                        ...
                        <div className="bg-gradient-to-r from-teal-600 to-teal-700 p-6 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-teal-100 mt-1">{selectedLevelName}</p>
                                </div>
            ...
            {showAssignModal && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
                        <div className="bg-gradient-to-r from-teal-600 to-teal-700 p-6 text-white flex-shrink-0">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h2 className="text-2xl font-bold">Assign User</h2>
                                    <p className="text-teal-100 mt-1">{assignTargetName}</p>
                                </div>
                                        ...
                                        {availableUsers.map((user) => (
                                            <div key={user.user_id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                                                >
