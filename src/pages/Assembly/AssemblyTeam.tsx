...
export default function AssemblyTeam() {
    ...
    const [assemblyData, setAssemblyData] = useState<AssemblyTeamResponse['data'] | null>(null);
    ...
    useEffect(() => {
        const fetchAssemblyTeam = async () => {
            ...
            try {
                ...
                const data: AssemblyTeamResponse = await response.json();
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white mb-6">
                <h1 className="text-3xl font-bold">{assemblyData.location.location_name} Assembly Team</h1>
                <p className="text-blue-100 mt-2">Manage and view assembly team members</p>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900 mt-2">{assemblyData.total_users}</p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-green-600 mt-2">{assemblyData.active_users}</p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-red-600 mt-2">{assemblyData.inactive_users}</p>
                        </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <p className="text-sm text-gray-600">
                    Showing {filteredUsers.length} of {assemblyData.users.length} users
                </p>
            </div>
