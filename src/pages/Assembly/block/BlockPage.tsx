...
//         <h1 className="text-xl font-bold text-[var(--text-color)]">Block List</h1>
//       </div>
...
//             <input type="text" value={loggedInUser?.state || ""} disabled className="w-full px-3 py-2 border rounded bg-gray-200 text-[var(--text-secondary)] cursor-not-allowed" />
//           </div>
//           <div>
//             <label className="text-sm">District</label>
//             <input type="text" value={loggedInUser?.district || ""} disabled className="w-full px-3 py-2 border rounded bg-gray-200 text-[var(--text-secondary)] cursor-not-allowed" />
//           </div>
//           <div>
...
export default function AssemblyBlockPage() {
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold text-[var(--text-color)] mb-4">Block page</h1>
            <div className="bg-[var(--bg-card)] rounded-lg shadow p-6">
                <p className="text-[var(--text-secondary)]">Assembly Block members will be displayed here</p>
            </div>
        </div>
    );
}
