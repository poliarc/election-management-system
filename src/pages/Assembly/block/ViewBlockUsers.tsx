...
export default function ViewBlockUsers() {
    ...
    // Debug logging
    console.log("=== ViewBlockUsers Debug ===");
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-[var(--text-color)]">{totalUsers}</p>
                            </div>
                        </div>
                        <button
                            onClick={() =>
                                navigate(
                                    `/assembly/block/assign?blockId=${blockId}&blockName=${encodeURIComponent(blockName)}`
                                )
                            }
