...
export default function CreateBlock() {
    ...
    const blockLevel = partyLevels.find((level) => level.level_name === "Block");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!blockLevel) {
            toast.error("Block level configuration not found");
            return;
        }
        ...
        try {
            await createBlock({
                ...
                partyLevelId: blockLevel.party_wise_id,
            }).unwrap();

            toast.success("Block created successfully");
            navigate("/assembly/block");
        } catch (error: any) {
            toast.error(error?.data?.message || "Failed to create block");
        }
    };
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <p className="mt-2 text-xs text-gray-500">
                                Enter the name of the block within this assembly
                            </p>
                        </div>
                        ...
                        <div className="flex gap-4 pt-4">
                            <button
                                type="submit"
                                disabled={isLoading || !blockName.trim() || !blockLevel}
