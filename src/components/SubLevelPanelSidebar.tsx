...
const Icons = {
  ...
  voters: (
    ...
    >
      <path
        d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm10 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm4 10v-2a4 4 0 0 0-3-3.87"
        strokeWidth={1.4}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    ...
    <aside className="w-68 shrink-0 h-full border-r border-gray-200 bg-white flex flex-col overflow-y-auto">
          ...
          {vicDropdownOpen && (
            <div className="mt-2 ml-2 pl-2 border-l border-gray-200 space-y-1">
              {vicMenuItems.map((item) => (
                ...
                >
                  <span className="text-teal-600">{Icons.vic}</span>
                  <span className="truncate">{item.label}</span>
                </NavLink>
              ))}
            </div>
      ...
      <div className="mt-auto pt-3 pb-5 border-t border-gray-200">
        ...
        <div className="px-4 space-y-2">
          ...
          >
            <svg
              className="h-5 w-5 stroke-[1.6] text-teal-600"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            >
