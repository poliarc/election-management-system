      ...
      <tr className="bg-blue-50 border-t-2 border-blue-200">
        <td colSpan={colSpan} className="px-0 py-0">
          <div className="bg-gradient-to-b from-blue-50 to-white border-l-4 border-blue-400">
            ...
            {/* User Table */}
            <div className="px-6 py-4 max-h-[400px] overflow-y-auto bg-[var(--bg-card)]">
              {filteredUsers.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r bg-[var(--bg-card)]">
                      <tr>
                    ...
                    <tbody className="bg-[var(--bg-card)] divide-y divide-blue-100">
                      {filteredUsers.map((user, index) => (
                        <tr key={user.assignment_id || index} className="hover:bg-[var(--bg-hover)] even:bg-[var(--bg-main)]/50">
