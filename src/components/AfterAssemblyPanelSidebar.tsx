          ...
          {voterDropdownOpen && (
            <div className="mt-2 ml-2 pl-2 border-l border-[var(--border-color)] space-y-1">
              ...
              {searchModule && (
                ...
                >
                  <span className="text-indigo-600">{getIconForModule(searchModule.moduleName)}</span>
                  <span className="truncate">{searchModule.displayName}</span>
                </NavLink>
              )}

              <NavLink
                to={`${base}/After-Assembly-Mark-Voter`}
                onClick={() => {
                  onNavigate?.();
                }}
                className={({ isActive }) =>
              ...
              >
                <span className="text-indigo-600">{Icons.team}</span>
